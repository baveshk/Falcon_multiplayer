# File: client.py
# Description: Client side for managing the 'Falcon Jet' game
import json
import socket
import threading
import time
...
class Client:
    ...
    def startup_screen(self):
        ...
        #image_object = canvas.create_image(0, 0, image=image_file, anchor=tk.NW)
        ...
        heading = tk.Label(root, text="Falcon Jet Fighter", font=('Calibri Bold', 20), bg='#fff')
        heading.pack()
